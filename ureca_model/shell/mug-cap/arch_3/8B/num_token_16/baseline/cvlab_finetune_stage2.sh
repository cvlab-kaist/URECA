...
ARCH_NAME="ARCH_3"
GROUP_NAME="${ARCH_NAME}/8B-num_mask16"
...
CUDA_VISIBLE_DEVICES='4,5,6,7' /scratch/slurm-user24-kaist/miniconda3/envs/mug-cap/bin/torchrun \
  ...
  --model_name_or_path "/scratch/slurm-user24-kaist/sangbeom/media/training/a100/ARCH_3/8B-num_mask16/stage_1/checkpoint-8600" \
  --conv_style "mug-cap" \
