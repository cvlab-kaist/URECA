...
CUDA_VISIBLE_DEVICES='1,3,4,5,6,7' /scratch/slurm-user24-kaist/miniconda3/envs/mug-cap/bin/torchrun \
  --nnodes=1 \
  --node_rank=0 \
  ...
  --model_name_or_path "/scratch/slurm-user24-kaist/sangbeom/media/training/a100/ARCH_3/8B-num_mask16-size_aug-dynamic_mask/stage_1/checkpoint-8635" \
  --conv_style "mug-cap" \
