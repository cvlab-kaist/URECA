...
CUDA_VISIBLE_DEVICES='0,1,2,3' /home/cvlab14/miniconda3/envs/internvl/bin/torchrun \
  ...
  internvl/train/mug-cap_arch_2_train_with_test.py \
  --model_name_or_path "/scratch/slurm-user24-kaist/sangbeom/media/training/a100/ARCH_2/8B-num_mask8-size_aug-dynamic_mask/stage_1" \
  --conv_style "mug-cap" \
