...
import transformers
from internvl.logger import WandbPredictionProgressCallback
from internvl.dist_utils import init_dist
from internvl.model.internlm2.modeling_internlm2 import InternLM2ForCausalLM
from internvl.model.internvl_chat import (InternVisionConfig,
                                          InternVisionModel,
                                          InternVLChatConfig, MugCapModel_2)
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        ...
        model = MugCapModel_2.from_pretrained(
    ...
    if model_args.freeze_mask_mlp:
        ...
        _freeze_params(model.concat_mask_encoder)
        _freeze_params(model.concat_mask_linear)
